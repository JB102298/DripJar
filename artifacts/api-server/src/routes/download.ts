...
const PDF_PATH = path.resolve(process.cwd(), "../../TripJar-Codebase.pdf");
...
const EXPECTED_BASENAME = "TripJar-Codebase.pdf";
...
// Serves the most recently generated TripJar-Codebase.pdf.
