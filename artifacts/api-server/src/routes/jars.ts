...
const DEFAULT_AGREEMENT_TEXT = `TripJar Savings Agreement
...
4. CANCELLATION: If the Jar is cancelled before any Commitment Request is approved, all members may request a full refund of their simulated contributions. TripJar does not guarantee refunds for amounts already paid to third-party vendors.

5. REFUNDS: Refund requests are subject to review. TripJar is not responsible for amounts already transferred to external vendors, airlines, hotels, or other service providers.

6. SIMULATED PAYMENTS: This version of TripJar uses simulated payment data. No real money is transferred. This agreement will be updated before real financial transactions are enabled.
