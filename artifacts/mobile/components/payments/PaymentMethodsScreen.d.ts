/**
 * Type declaration for the platform-specific PaymentMethodsScreen pair.
 *
 * Metro resolves `PaymentMethodsScreen.native.tsx` or `.web.tsx` by platform at
...
declare const PaymentMethodsScreen: ComponentType<Record<string, never>>;
